...
from main import create_product, create_task, execute_task, export_products, TaskCreate

def main():
    pid1 = create_product("批量商品1", "http://example.com/b1", "批量")
    pid2 = create_product("批量商品2", "http://example.com/b2", "批量")
